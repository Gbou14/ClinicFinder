...
Run `python main.py`, enter a ZIP code, and request 10-100 results. The default
...
The `Facebook Follow-up` sheet lists clinics without a preferred public inbox.
It includes any Facebook page linked from the clinic's own website plus a
one-click Google search for the clinic name, address, and Facebook. Facebook
email collection remains a manual follow-up step; the app does not log in to or
scrape Facebook.
