...
class ClinicFinderApp(tk.Tk):
    def __init__(self):
        ...
        ttk.Spinbox(container, from_=10, to=100, textvariable=self.target_count, width=16).grid(
    ...
    def start_run(self):
        ...
        if not 10 <= target_count <= 100:
            messagebox.showerror("Invalid clinic count", "Choose a number from 10 to 100.")
            return
